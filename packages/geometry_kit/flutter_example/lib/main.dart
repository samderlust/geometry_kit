...
class DemoList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final demos = <(String, String, Widget)>[
      (
        'Shape Drawing',
        'Hexagon, circle, arc, pentagon, triangle on Canvas',
        const ShapeDrawingDemo(),
      ),
      ('Hit Testing', 'Tap to check point-in-shape', const HitTestingDemo()),
      (
        'Animated Transforms',
        'Rotating & scaling polygon',
        const AnimatedTransformDemo(),
      ),
      (
        'Measurements',
        'Line length & angle annotations',
        const MeasurementDemo(),
      ),
      (
        'Raycasting',
        'Ray-wall & ray-circle intersection',
        const RaycastingDemo(),
      ),
      (
        'Circle Intersections',
        'Drag circles, see intersection points & tangent',
        const CircleIntersectionDemo(),
      ),
      (
        'Rectangle',
        'Contains, overlaps, diagonal, isSquare',
        const RectangleDemo(),
      ),
      (
        'Ellipse',
        'Foci, eccentricity, pointAt trace, contains',
        const EllipseDemo(),
      ),
      (
        'Line Tools',
        'Lerp, extend, projectPoint, parallel/perp',
        const LineToolsDemo(),
      ),
      (
        'Polygon Info',
        'Convex, winding, centroid, closest vertex, bbox',
        const PolygonInfoDemo(),
      ),
      (
        'Triangle',
        'Classification, circumcircle, incircle, centroid',
        const TriangleDemo(),
      ),
      (
        'Bezier Curves',
        'Quadratic & cubic, split, bounding box',
        const BezierDemo(),
      ),
      (
        'Capsule',
        'Stadium shape, contains, endCaps, bounding box',
        const CapsuleDemo(),
      ),
      (
        'Polyline',
        'Simplify (RDP), pointAt, segments, bbox',
        const PolylineDemo(),
      ),
      (
        'Quadrilateral',
        'Classification: parallelogram, rhombus, kite...',
        const QuadrilateralDemo(),
      ),
      (
        'Ring / Annulus',
        'Contains, width, inner/outer circumference',
        const RingDemo(),
      ),
      (
        'Spline',
        'Catmull-Rom, tangent, sample, control points',
        const SplineDemo(),
      ),
    ];
